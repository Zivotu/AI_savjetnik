        ...
        <AnimatePresence mode="wait">
          {!isChatActive ? (
            ...
            >
              ...
              >
                {[
                  { icon: Brain, title: "AI analiza", desc: "Napredni algoritmi analiziraju vaše potrebe" },
                  { icon: Sparkles, title: "Brza rješenja", desc: "Konkretni prijedlozi u samo 90 sekundi" },
                  { icon: Phone, title: "Personalizirano", desc: "Rješenja prilagođena vašoj industriji" }
                ].map((feature, i) => (
                  <motion.div
                    key={i}
                    ...
                    {[
                      {
                        ...
                        description: "Kako AI može povećati konverziju za 40% kroz personalizaciju",
                        stats: "40% ↑",
                        color: "blue"
                      },
                      {
                        ...
                        description: "Smanjite vrijeme odgovora na 30 sekundi s AI asistentom",
                        stats: "85% brže",
                        color: "purple"
                      },
                      {
                        ...
                        description: "Predvidite trendove i optimizirajte zalihe pomoću AI modela",
                        stats: "25% ROI",
                        color: "orange"
                      },
                      {
                        ...
                        description: "Kreirajte kampanje koje konvertiraju 3x bolje",
                        stats: "3x ROI",
                        color: "green"
                      },
                      {
                        ...
                        description: "Implementacija voice AI rješenja za bolju korisničku uslugu",
                        stats: "24/7",
                        color: "indigo"
                      },
                      {
                      ...
                      >
                        {/* Grafika članka */}
                        <div className={`relative h-48 bg-gradient-to-br ${article.gradient} p-8 flex items-center justify-center overflow-hidden`}>
                          {/* Pozadinski pattern */}
                          ...
                          <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-md rounded-full px-3 py-1">
                            <span className="text-white font-bold text-sm">{article.stats}</span>
                          </div>
                        </div>
                        ...
                        <div className="p-6">
                          <div className="flex items-center gap-3 mb-3">
                            <span className={`px-3 py-1 rounded-full text-xs font-medium bg-${article.color}-500/20 text-${article.color}-400 border border-${article.color}-500/30`}>
                              {article.category}
                            </span>
                        ...
                        {/* Hover overlay efekt */}
                        <motion.div 
                          className="absolute inset-0 bg-gradient-to-t from-purple-600/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                        />
                      </motion.article>
                    ))}
                  </div>
